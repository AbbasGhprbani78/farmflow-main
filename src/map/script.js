...
(function (root, factory) {
  ...
  function ha(a) {
    this.message =
      "Assertion failed. See https://openlayers.org/en/v4.6.5/doc/errors/#" +
      a +
      " for details.";
    this.code = a;
  ...
  */
  ...
  function rb(a, b) {
    ...
    switch (e) {
      ...
      case "GeometryCollection":
        d = a.vd();
        a = 0;
        for (e = d.length; a < e; ++a) c += rb(d[a], b);
        break;
      default:
  ...
  function qb(a, b, c) {
    ...
    d =
      ...
      Math.sin(a) * Math.sin(a) * Math.cos(d) * Math.cos(e);
  ...
  function pb(a, b) {
    for (
      var c = 0, d = a.length, e = a[d - 1][0], f = a[d - 1][1], g = 0;
      g < d;
      g++
    ) {
      var h = a[g][0],
  ...
  function Nb(a, b, c, d) {
    ...
    e
      ...
      : ("degrees" == a.a && !d) ||
        ...
        (b = e(b, b, 2)),
        (b =
          (Mb.b(b.slice(0, 2), b.slice(2, 4)) +
            Mb.b(b.slice(4, 6), b.slice(6, 8))) /
          2),
        (a = d ? ub[d] : a.Bc()),
        void 0 !== a && (b /= a));
    return b;
    ...
    if (!e) {
      ...
      if ("function" == typeof f) {
        ...
        void 0 !== g &&
          ...
          (g === h
            ? Qb([b, a])
            : ((e = f(d, c)), Vb(b, a, e.forward, e.inverse)),
          (e = Lb(c, d)));
      }
    }
    e || (e = $b);
  ...
  function qc(a) {
    ...
    this.c = null;
    void 0 !== a.origins &&
      ((this.c = a.origins), oa(this.c.length == this.b.length, 20));
    d = a.extent;
    void 0 === d || this.g || this.c || (this.g = $a(d));
    oa((!this.g && this.c) || (this.g && !this.c), 18);
    this.i = null;
    void 0 !== a.tileSizes &&
      ((this.i = a.tileSizes), oa(this.i.length == this.b.length, 19));
  ...
  function yc(a, b) {
    var c = a.Ic(b[0]),
      d = a.Ta(b[0]);
    a = Ba(a.Za(b[0]), a.f);
    return [c[0] + (b[1] + 0.5) * a[0] * d, c[1] + (b[2] + 0.5) * a[1] * d];
  }
  k.Ma = function (a, b) {
    var c = this.Ic(a[0]),
      d = this.Ta(a[0]),
  ...
  function y(a, b, c, d, e) {
    ...
    (f = Hc(g, c, d, !1))
      ? e || (f.Eh = !1)
      : ((f = { Ch: d, Eh: !!e, listener: c, target: a, type: b }),
  ...
  Sc.prototype.removeEventListener = function (a, b) {
    ...
    c &&
      ...
      a in this.Wa
        ? ((c[b] = ea), ++this.Wa[a])
        : (c.splice(b, 1), 0 === c.length && delete this.oa[a]));
  };
  function Uc() {
    Sc.call(this);
    this.g = 0;
  ...
  k.set = function (a, b, c) {
    c
      ? (this.N[a] = b)
      : ((c = this.N[a]), (this.N[a] = b), c !== b && Yc(this, a, c));
  };
  k.H = function (a, b) {
  ...
  var hd,
    ...
    qd = "DeviceOrientationEvent" in window,
  ...
  k.Om = function (a, b) {
    ...
    if (c) {
      ...
      d &&
        ...
        (d.target = e),
        b.target
          ? (Jd(this.b, d, a), Hd(this.b, b, a))
          : ((b.target = e), (b.relatedTarget = null), this.Of(a, b)));
      c.out = b;
      c.pj = b.target;
    }
  };
  ...
  k.Rq = function (a, b) {
    ...
    b.isPrimary &&
      ((this.g = void 0), (this.c = setTimeout(this.Ej.bind(this), 200)));
  };
  k.Nq = function (a) {
    Ud(this, a, this.Of);
  };
  ...
  function Xd(a) {
    ...
    td
      ...
      : ud
      ? Yd(this, new Kd(this))
      : ((a = new Cd(this)), Yd(this, a), sd && Yd(this, new Sd(this, a)));
    a = this.a.length;
  ...
  function Hd(a, b, c) {
    ...
    var d = b.target,
      e = b.relatedTarget;
    (d && e && d.contains(e)) ||
      ((b.bubbles = !1), Gd(a, "pointerenter", b, c));
  }
  function Gd(a, b, c, d) {
    a.b(new Md(b, d, c));
  }
  ...
  function ce(a, b) {
    ...
    a.b(c);
    0 !== a.j
      ? (clearTimeout(a.j), (a.j = 0), (c = new Ad("dblclick", a.g, b)), a.b(c))
      : (a.j = setTimeout(
          function () {
            this.j = 0;
  ...
  function de(a, b) {
    "pointerup" == b.type || "pointercancel" == b.type
      ? delete a.o[b.pointerId]
      : "pointerdown" == b.type && (a.o[b.pointerId] = !0);
  ...
  k.pm = function (a) {
    ...
    this.c = a;
    0 === this.i.length &&
      ((this.a = new Xd(document)),
      this.i.push(
        y(this.a, "pointermove", this.mn, this),
        y(this.a, "pointerup", this.ci, this),
        y(this.f, "pointercancel", this.ci, this)
      ));
  };
  k.mn = function (a) {
    if (fe(this, a)) {
  ...
  function fe(a, b) {
    return (
      Math.abs(b.clientX - a.c.clientX) > a.D ||
      Math.abs(b.clientY - a.c.clientY) > a.D
    );
  }
  k.ia = function () {
  ...
  le.prototype.l = function (a) {
    ...
    if (2 === b || 3 === b || 4 === b || 5 === b)
      Mc(a, "change", this.l, this),
        (a = a.lb()),
        a in this.f && (delete this.f[a], --this.j),
        this.v();
  };
  function me(a, b, c) {
    for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length; )
      (g = he(a)[0]),
        ...
        5 === f
          ? (e = !0)
          : 0 !== f || h in a.f || ((a.f[h] = !0), ++a.j, ++d, g.load());
    0 === d && e && a.v();
  }
  function ne(a) {
    return function (b) {
          ...
          for (; b < q; ) {
            ...
            if (Ia != S || ta != g) {
              var la = S - A,
                ...
                xa = ta - E;
              (la * xa == ca * ia &&
                ((0 > la && ia < la) || la == ia || (0 < la && ia > la)) &&
                ((0 > ca && xa < ca) || ca == xa || (0 < ca && xa > ca))) ||
                ((v[z++] = S), (v[z++] = g), (A = S), (E = g));
              S = Ia;
              g = ta;
            }
  ...
  k.Nb = function (a, b, c, d) {
    ...
    this.c != this.g &&
      ((this.j = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0))),
      (this.c = this.g));
  ...
  function If(a, b, c, d, e, f, g) {
    for (
      var h, l, m, n, p, q = e[f + 1], r = [], u = 0, v = c.length;
      u < v;
      ++u
    ) {
      var z = c[u];
    ...
    for (l = r.length; h < l; ++h)
      (n = r[h]),
        (z = Math.abs(n - m)),
        z > v &&
          ((m = (m + n) / 2), Hf(a, b, c, d, m, q) && ((u = m), (v = z))),
        (m = n);
    isNaN(u) && (u = e[f]);
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ha(this.G(), a, b)) return d;
    this.C != this.g &&
      ((this.B = Math.sqrt(qf(this.A, 0, this.c, this.a, 0))),
      (this.C = this.g));
  ...
  function Vf(a, b) {
    ...
    if (void 0 !== b.resolutions) {
      ...
      l = h.G();
      g =
        (l ? Math.max(cb(l), db(l)) : (360 * ub.degrees) / h.Bc()) /
        256 /
        Math.pow(2, 0);
    ...
    void 0 !== b.resolution
      ...
      : void 0 !== b.zoom &&
        ((c.resolution = a.constrainResolution(a.a, b.zoom - a.s)),
      ...
      for (
        ...
        void 0 !== m.zoom
          ? ((n.ke = f),
            ...
            (f = n.kd))
          : m.resolution && ((n.ke = f), (n.kd = m.resolution), (f = n.kd));
        void 0 !== m.rotation &&
          ((n.Df = g),
          (n.ne = g + (wa(m.rotation - g + Math.PI, 2 * Math.PI) - Math.PI)),
          (g = n.ne));
        n.callback = c;
        (n.ie && n.me && !Ee(n.ie, n.me)) || n.ke !== n.kd || n.Df !== n.ne
          ? (d += n.duration)
          : (n.complete = !0);
        h.push(n);
      }
  ...
  k.Ff = function () {
    ...
    if (this.Ac()) {
      for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
        for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
          ...
          if (!h.complete) {
            ...
            void 0 !== h.Df &&
              ...
              ((b =
                1 === b
                  ? wa(h.ne + Math.PI, 2 * Math.PI) - Math.PI
                  : h.Df + b * (h.ne - h.Df)),
        ...
        e &&
          ((this.c[c] = null), bg(this, 0, -1), (d = d[0].callback) && d(!0));
      }
  ...
  k.Uf = function (a, b) {
    ...
    var e = void 0 !== b.padding ? b.padding : [0, 0, 0, 0],
      ...
      h;
    void 0 !== b.minResolution
      ? (h = b.minResolution)
      : void 0 !== b.maxZoom
      ? (h = this.constrainResolution(this.a, b.maxZoom - this.s, 0))
      : (h = 0);
    var l = d.da(),
      m = this.Sa();
    a = Math.cos(-m);
    ...
    void 0 !== b.duration
      ? this.animate(
          { resolution: c, center: a, duration: b.duration, easing: b.easing },
          e
        )
      : (this.gd(c), this.ub(a), setTimeout(e.bind(void 0, !0), 0));
  };
  k.Nk = function (a, b, c) {
    var d = this.Sa(),
      e = Math.cos(-d);
  ...
  function mg(a) {
    ...
    b
      ? Array.isArray(b)
        ? (b = new B(b.slice(), { unique: !0 }))
        : oa(b instanceof B, 43)
      : (b = new B(void 0, { unique: !0 }));
    this.Qi(b);
  }
  w(mg, kg);
  k = mg.prototype;
  ...
  k.dg = function (a) {
    ...
    for (d = b.length; c < d; c++) {
      ...
      void 0 !== a.extent &&
        (e.extent = void 0 !== e.extent ? gb(e.extent, a.extent) : a.extent);
    }
    return b;
  };
  k.hg = function () {
    ...
    if (this.c)
      return (
        ...
        this.pc.wa(
          a,
          this.c,
          void 0 !== c.hitTolerance ? c.hitTolerance * this.c.pixelRatio : 0,
          b,
          null,
          void 0 !== c.layerFilter ? c.layerFilter : Re,
          null
        )
      );
  };
  ...
  k.ng = function (a, b) {
    ...
    return this.pc.Ui(
      a,
      this.c,
      void 0 !== b.hitTolerance ? b.hitTolerance * this.c.pixelRatio : 0,
      void 0 !== b.layerFilter ? b.layerFilter : Re,
      null
    );
  };
  k.Sd = function (a) {
  ...
  k.Am = function () {
    ...
    var a = this.aa();
    a &&
      (this.a.setAttribute("data-view", x(a)),
  ...
  k.pq = function () {
    ...
    g &&
      ...
      !f ||
        (this.f && (bb(this.f) || Sa(g.extent, this.f))) ||
        (this.b(new dd("movestart", this, f)), (this.f = Oa(this.f))),
      !this.f ||
        g.viewHints[0] ||
        g.viewHints[1] ||
        Sa(g.extent, this.f) ||
        (this.b(new dd("moveend", this, g)), Ga(g.extent, this.f)));
  ...
  function sg(a) {
    ...
    void 0 !== a.overlays
      ? Array.isArray(a.overlays)
        ...
        : (oa(a.overlays instanceof B, 49), (a = a.overlays))
      : (a = new B());
    return {
      controls: q,
      interactions: r,
  ...
  vg.prototype.setMap = function (a) {
    ...
    if ((this.a = a))
      (this.T ? this.T : a.v).appendChild(this.element),
        this.render !== ea &&
          this.s.push(y(a, "postrender", this.render, this)),
        a.render();
  };
  ...
  function zg(a) {
    ...
    "string" === typeof d
      ? ((this.D = document.createElement("span")), (this.D.textContent = d))
      : (this.D = d);
  ...
  function Ag(a) {
    if ((a = a.frameState)) {
      ...
      if (!jc(c, this.B)) {
        ...
        this.C != b &&
          ((this.element.style.display = b ? "" : "none"), (this.C = b));
        this.B = c;
        a = a.logos;
        c = this.O;
        ...
        for (var n in a)
          if (
            ((d = a[n]),
            d instanceof HTMLElement && (this.l.appendChild(d), (c[n] = d)),
            !(n in c))
          ) {
            var p = new Image();
            p.src = n;
  ...
  Cg.prototype.D = function (a) {
    ...
    void 0 !== this.l
      ...
      : (a = this.a.aa()) &&
        void 0 !== a.Sa() &&
        (0 < this.v
          ? a.animate({ rotation: 0, duration: this.v, easing: Oe })
          : a.ce(0));
  };
  function Dg(a) {
    if ((a = a.frameState)) {
  ...
  Eg.prototype.j = function (a, b) {
    ...
    if ((b = this.a.aa())) {
      var c = b.Pa();
      c &&
        ((a = b.constrainResolution(c, a)),
        0 < this.c
          ? (b.Ac() && b.rd(),
            b.animate({ resolution: a, duration: this.c, easing: Oe }))
          : b.gd(a));
    }
  };
  function Fg(a) {
    ...
    (void 0 !== a.attribution ? a.attribution : 1) &&
      b.push(new zg(a.attributionOptions));
    return b;
  }
  function Gg(a, b, c) {
    this.i = a;
  ...
  function Kg(a, b, c, d) {
    if (void 0 !== b) {
      var e = a.Sa(),
        f = a.xa();
      void 0 !== e && f && 0 < d
        ? a.animate({ rotation: b, anchor: c, duration: d, easing: Oe })
        : a.rotate(b, c);
    }
  }
  function Lg(a, b, c, d) {
  ...
  function Tg(a, b, c, d) {
    if (b) {
      var e = a.Pa(),
        f = a.xa();
      void 0 !== e && f && b !== e && d
        ? a.animate({ resolution: b, anchor: c, duration: d, easing: Oe })
  ...
  function gh(a) {
    ...
    this.D
      ? "pointerdrag" == a.type
        ? this.Ek(a)
        : "pointerup" == a.type && (this.D = this.Lk(a) && 0 < this.l.length)
      : "pointerdown" == a.type
      ? ((this.D = a = this.ck(a)), (b = this.jd(a)))
      : "pointermove" == a.type && this.Kk(a);
    return !b;
  }
  ...
  function nh(a) {
    return dh(a) && Yg(a) && this.f(a)
      ? (bg(a.map.aa(), 1, 1), (this.a = void 0), !0)
      : !1;
  }
  mh.prototype.jd = Se;
  function qh(a) {
  ...
  function wh(a) {
    if (!dh(a)) return !0;
    this.a.setMap(null);
    this.s(a, this.f, a.pixel) &&
      (this.j(a), this.b(new yh(Ah, a.coordinate, a)));
    return !1;
  }
  function uh(a) {
      ...
      if (this.f(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
        ...
        if ((e = b.xa()))
          (d = b.Sc([e[0] + d[0], e[1] + d[1]])),
            c ? b.animate({ duration: c, easing: Qe, center: d }) : b.ub(d);
        a.preventDefault();
        b = !0;
      }
    }
  ...
  function Ih(a) {
    ...
    if (this.l === Ph) {
      ...
      var e = b.i,
        ...
        g = 0;
      c < e
        ? ((c = Math.max(c, e / 1.5)), (g = 1))
        : c > f && ((c = Math.min(c, 1.5 * f)), (g = -1));
      if (this.a) {
        var h = cg(b, c, this.a);
        b.ub(b.Sc(h));
      }
  ...
  function Zh(a) {
    ...
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      b.push(new Dh()),
        b.push(new Fh({ delta: a.zoomDelta, duration: a.zoomDuration }));
  ...
  k.get = function (a) {
    ...
    a === this.g
      ? ((this.g = this.g.kb), (this.g.Pb = null))
      : ((a.kb.Pb = a.Pb), (a.Pb.kb = a.kb));
    a.kb = null;
    a.Pb = this.c;
    this.c = this.c.kb = a;
    return a.Pc;
        ...
        if ((d = wg(d)))
          for (var f = 0, g = d.length; f < g; ++f) {
            ...
            m in c ||
              ((c[m] = 60),
              a(m) ||
                ((c[m] = 0), void 0 === e && (e = window.setInterval(b, 32))));
          }
      };
    })();
  function mi() {
    ...
    return function (c) {
      if (a.hasOwnProperty(c)) var d = a[c];
        ...
        if (ti.exec(d)) {
          ...
          0 == d.indexOf("rgba(")
            ? ((d = d.slice(5, -1).split(",").map(Number)), (f = yi(d)))
            : 0 == d.indexOf("rgb(")
  ...
  function Ei(a, b) {
    ...
    d
      ...
      : ((c.fillStyle = b.fillStyle), (a.T = { fillStyle: b.fillStyle }));
  }
  function Fi(a, b) {
    var c = a.g,
      d = a.O;
    d
      ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap),
        od &&
          (jc(d.lineDash, b.lineDash) ||
            c.setLineDash((d.lineDash = b.lineDash)),
          d.lineDashOffset != b.lineDashOffset &&
            (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)),
      ...
      : ((c.lineCap = b.lineCap),
        od &&
          (c.setLineDash(b.lineDash), (c.lineDashOffset = b.lineDashOffset)),
  ...
  k.nb = function (a) {
    if (a) {
      var b = a.Fa();
      b
        ? ((b = b.b), (this.j = { fillStyle: zi(b ? b : ei) }))
        : (this.j = null);
      var c = a.Ga();
      if (c) {
        b = c.a;
      ...
      for (q = v.fa; q <= v.la; ++q)
        for (r = v.ea; r <= v.ka; ++r)
          if (g - u <= h) {
            ...
            0 == A.getState() &&
              ((p[A.lb()] = !0), A.lb() in a.a || a.i([A, n, yc(c, A.ya), z]));
            void 0 !== l && l.call(m, A);
          } else b.kh(u, q, r, e);
    }
  }
  ...
  function Zi(a, b, c, d, e) {
    ...
    if (Tc(f, b)) {
      ...
      f.b(
        new bi(
          b,
          new Bi(c, d.pixelRatio, d.extent, a, d.viewState.rotation),
          d,
          c,
          null
        )
  ...
  bj.handles = function (a, b) {
    return (
      "canvas" === a &&
      ("IMAGE" === b.S() || ("VECTOR" === b.S() && "image" === b.l))
    );
  };
  ...
  bj.prototype.wa = function (a, b, c, d, e) {
    return this.c
      ? this.c.wa(a, b, c, d, e)
      : aj.prototype.wa.call(this, a, b, c, d, e);
  };
  function cj() {
    this.b = {};
    this.a = 0;
  ...
  mj.prototype.$c = function (a, b) {
    ...
    if (
      ...
      if ((xa = this.context))
        (ia = l.Zd(p, c, f)),
          ...
          (la = xa.canvas),
          la.width != ca || la.height != ia
            ? ((this.C = r), (la.width = ca), (la.height = ia))
            : (this.c && !Sa(z, this.c) && xa.clearRect(0, 0, ca, ia),
              (r = this.C));
      this.f.length = 0;
    ...
    b = ef(
      ...
      b,
      0,
      ((this.c[0] - e[0]) / this.i) * c,
      ((e[1] - this.c[3]) / this.i) * c
    );
    ef(
      this.l,
      (c * d[0]) / 2 - b[4],
  ...
  mj.prototype.Sf = function (a, b, c, d, e, f, g, h, l) {
    if ((c = a.Y(this.a))) {
      var m = x(this),
        n = l ? qj(a, m, b.time) : 1;
      1 !== n ||
        this.a.ha().eg(b.viewState.projection) ||
        this.context.clearRect(d, e, f, g);
  ...
  (function (a) {
      ...
      for (; f > e; ) {
        if (600 < f - e) {
          ...
          c(
            a,
            b,
            Math.max(e, Math.floor(b - (l * n) / h + m)),
            Math.min(f, Math.floor(b + ((h - l) * n) / h + m)),
            g
          );
        }
        h = a[b];
    ...
    f.prototype = {
        ...
        for (var e = [], f, g, h, l; b; ) {
          ...
          for (g = b.children.length; f < g; f++)
            (h = b.children[f]),
              (l = b.fb ? d(h) : h),
              u(a, l) &&
                (b.fb ? c.push(h) : r(a, l) ? this.rh(h, c) : e.push(h));
          b = e.pop();
        }
        return c;
      },
        ...
        this.data.children.length
          ? this.data.height === a.height
            ...
            : (this.data.height < a.height &&
              ...
              this.vh(a, this.data.height - a.height - 1, !0))
          : (this.data = a);
        return this;
      },
      Ca: function (a) {
      ...
      remove: function (a, b) {
        if (!a) return this;
        for (
          var c = this.data, d = this.xb(a), e = [], f = [], g, h, l, m;
          c || e.length;
      ...
      th: function (a, b, c, d) {
        ...
        d ||
          ((d = Math.ceil(Math.log(e) / Math.log(f))),
          (f = Math.ceil(e / Math.pow(f, d - 1))));
        h = v([]);
        h.fb = !1;
        h.height = d;
        e = Math.ceil(e / f);
        ...
        for (var e, f, g, h, l, m, n, q; ; ) {
          ...
          for (f = b.children.length; e < f; e++)
            (g = b.children[e]),
              (l = p(g)),
              (m =
                (Math.max(g.la, a.la) - Math.min(g.fa, a.fa)) *
                  (Math.max(g.ka, a.ka) - Math.min(g.ea, a.ea)) -
                l),
              m < q
                ? ((q = m), (n = l < n ? l : n), (h = g))
                : m === q && l < n && ((n = l), (h = g));
      ...
      vh: function (a, b, c) {
        ...
        e.children.push(a);
        for (l(e, c); 0 <= b; )
          if (d[b].children.length > this.Lf) this.Dk(d, b), b--;
          else break;
        this.uk(c, d, b);
      },
      Dk: function (a, b) {
      ...
      wk: function (a, b, c) {
        ...
        for (d = b; d <= c - b; d++) {
          ...
          var m =
            Math.max(0, Math.min(g.la, l.la) - Math.max(g.fa, l.fa)) *
            Math.max(0, Math.min(g.ka, l.ka) - Math.max(g.ea, l.ea));
          g = p(g) + p(l);
          if (m < f) {
            f = m;
            var n = d;
      ...
      yk: function (a) {
        for (var b = a.length - 1, c; 0 <= b; b--)
          0 === a[b].children.length
            ? 0 < b
              ? ((c = a[b - 1].children), c.splice(c.indexOf(a[b]), 1))
              : this.clear()
            : g(a[b], this.xb);
      },
      Ak: function (a) {
  ...
  function zj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, v, z, A, E) {
    ...
    if (h) {
      if (q || 1 != h[4])
        Ta(h, v),
          (a = q
            ? [b, z ? z.slice(0) : null, m, e, n, p, u, l, c, d, r]
            : null) &&
            S &&
            a.push(A, E, xa, Va, ic, Xa),
          h.push(a);
      ...
      if (1 == d || d == b.length - 5) {
        ...
        if (!a.ra.Ok(c))
          for (a.ra.Ca(c), c = 5, d = b.length; c < d; ++c) {
            ...
            e &&
              (11 < e.length &&
                xj(a, e[0], e[13], e[14], e[15], e[16], e[11], e[12]),
              si.apply(void 0, e));
          }
        b.length = 5;
        Oa(b);
  ...
  function Hj(a, b, c, d, e, f, g) {
    ...
    for (
      ...
      switch (Z[0]) {
        case 0:
          var Zb = Z[1];
          (l && d[x(Zb).toString()]) || !Zb.U()
            ? (m = Z[2])
            : void 0 === g || hb(g, Zb.U().G())
            ? ++m
            : (m = Z[2] + 1);
          break;
        case 1:
        ...
        case 4:
          ...
          Ng
            ? Ng(h, p, q, 2, Wf)
            : ((Wf[0] = h[p]), (Wf[1] = h[p + 1]), (Wf.length = 2));
          Mg(Wf, ic);
          ++m;
          break;
        case 6:
              ...
              for (
                ...
                for (var Dp = Bp + Qg / 2; ve < zp - 2 && Ok + Oi < Dp; )
                  (Lh = Og),
                    ...
                    (Ok += Oi),
                    (Oi = Math.sqrt(
                      Math.pow(Og - Lh, 2) + Math.pow(Pg - Mh, 2)
                    ));
                var Ju = Dp - Ok,
  ...
  k.Oa = function (a, b) {
    ...
    b
      ? ((a = b.a),
        ...
        c.lineWidth > this.Wa && ((this.Wa = c.lineWidth), (this.i = null)))
  ...
  Nj.prototype.pd = function (a) {
    void 0 != a.$d &&
      ...
      (this.a.push([12]), (a.$d = this.coordinates.length));
    a.$d = 0;
      ...
      if ("line" === e.placement) {
        ...
        switch (f) {
          ...
          case "MultiPolygon":
            ...
            for (f = n.length; g < f; g += 3)
              (e.overflow || n[g + 2] / this.resolution >= p) &&
                d.push(n[g], n[g + 1]);
            g = d.length;
            if (0 == g) return;
        }
        ...
        if (e.backgroundFill || e.backgroundStroke)
          this.Oa(e.backgroundFill, e.backgroundStroke),
            Kj(this, this.state, this.Ah, a),
            Lj(this, this.state, this.pd);
        Uj(this, l, c, g);
      }
      Fj(this, b);
    }
  ...
  Sj.prototype.Y = function (a, b, c, d) {
    ...
    if (!ii.a.hasOwnProperty(e)) {
      ...
      d &&
        ...
        od &&
          f.lineDash.length &&
          (r.setLineDash(f.lineDash), (r.lineDashOffset = f.lineDashOffset)));
  ...
  Sj.prototype.nb = function (a, b) {
    ...
    if (a) {
      this.N = b;
      (d = a.Fa())
        ? ((b = this.c), b || (b = this.c = {}), (b.fillStyle = zi(d.b || ei)))
        : (b = this.c = null);
      if ((c = a.Ga())) {
        d = this.g;
        d || (d = this.g = {});
  ...
  k.wa = function (a, b, c, d, e, f, g) {
    ...
    d = Math.round(d);
    var l = 2 * d + 1,
      m = ef(this.j, d + 0.5, d + 0.5, 1 / b, -1 / b, -c, -a[0], -a[1]),
      n = this.f;
    n.canvas.width !== l || n.canvas.height !== l
      ? ((n.canvas.width = l), (n.canvas.height = l))
      : n.clearRect(0, 0, l, l);
    if (void 0 !== this.i) {
      var p = Da();
    ...
    for (b = a.length - 1; 0 <= b; --b) {
      ...
      for (d = uj.length - 1; 0 <= d; --d) {
        ...
        if (void 0 !== A)
          if (!g || ("Image" != z && "Text" != z)) {
            if ((A = Ij(A, n, m, c, e, h, p))) return A;
          } else {
            var E = g[u];
  ...
  k.Ja = function (a, b) {
    ...
    c = a[b];
    void 0 === c &&
      ((c = new bk[b](this.o, this.c, this.v, this.s, this.l, this.a)),
      (a[b] = c));
    return c;
  };
  k.yg = function () {
  ...
  k.$c = function (a) {
    ...
    c.D &&
      h.projection.g &&
      !La(n, a.extent) &&
      ((a = Math.max(cb(f) / 2, cb(n))), (f[0] = n[0] - a), (f[2] = n[2] + a));
        ...
        if (3 != la.getState()) {
          ...
          for (var Zb, Le = 0, Uf = Z.length; Le < Uf; ++Le)
            if (
              ((Zb = Z[Le]),
              ic &&
                ("tile-pixels" == Va.a && (Va.Sj(ca), Va.Si(la.G())),
                Zb.U().mb(Va, q)),
              !xa || hb(xa, Zb.U().G()))
            ) {
              var Id = void 0,
    ...
    if (null !== a.alpha) {
      ...
      "boolean" === typeof a.absolute && a.absolute
        ...
        : "number" === typeof a.webkitCompassHeading &&
          ...
          this.set(sk, va(a.webkitCompassHeading));
    }
  ...
  k.$m = function () {
    if (qd) {
      var a = this.li();
      a && !this.a
        ? (this.a = y(window, "deviceorientation", this.Dp, this))
        : a || null === this.a || (Gc(this.a), (this.a = null));
    }
  };
  k.rg = function (a) {
    this.set(qk, a);
  ...
  function xk(a, b) {
    ...
    if (void 0 === b) {
      ...
      a.Xa
        ? (a.D = a.o)
        : ((n = hg(c.size, c.size)), (a.D = n.canvas), a.Ih(c, n, 0, 0));
    } else (m = Math.round(m)), (d = !a.Xa) && (n = a.Ih.bind(a, c)), a.Ya ? ((e = a.Ya), void 0 === e.b && ((e.b = "s"), (e.b = e.a ? ("string" === typeof e.a ? e.b + e.a : e.b + x(e.a).toString()) : e.b + "-"), (e.b += "," + (void 0 !== e.f ? e.f.toString() : "-") + "," + (e.g ? e.g.toString() : "-") + "," + (void 0 !== e.i ? e.i : "-") + "," + (void 0 !== e.j ? e.j : "-") + "," + (void 0 !== e.l ? e.l.toString() : "-") + "," + (void 0 !== e.c ? e.c.toString() : "-"))), (e = e.b)) : (e = "-"), a.Xa ? ((f = a.Xa), void 0 === f.a && (f.a = f.b instanceof CanvasPattern || f.b instanceof CanvasGradient ? x(f.b).toString() : "f" + (f.b ? xi(f.b) : "-")), (f = f.a)) : (f = "-"), (a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.g == a.c[4] && a.j == a.c[5] && a.l == a.c[6]) || (a.c = ["r" + e + f + (void 0 !== a.b ? a.b.toString() : "-") + (void 0 !== a.g ? a.g.toString() : "-") + (void 0 !== a.j ? a.j.toString() : "-") + (void 0 !== a.l ? a.l.toString() : "-"), e, f, a.b, a.g, a.j, a.l]), (n = b.add(a.c[0], m, m, a.Jh.bind(a, c), n)), (a.o = n.image), (a.oa = [n.offsetX, n.offsetY]), (b = n.image.width), (a.D = d ? n.Bm : a.o);
    a.C = [m / 2, m / 2];
    a.qa = [m, m];
    a.B = [b, b];
  }
  k.Jh = function (a, b, c, d) {
    ...
    this.Ya &&
      ...
      (b.lineWidth = a.Wj),
      a.lineDash &&
        (b.setLineDash(a.lineDash), (b.lineDashOffset = a.lineDashOffset)),
      (b.lineCap = a.lineCap),
  ...
  function Gk() {
    var a = {},
      b = [255, 255, 255, 1],
      c = [0, 153, 255, 1];
    a.Polygon = [new Bk({ fill: new zk({ color: [255, 255, 255, 0.5] }) })];
    a.MultiPolygon = a.Polygon;
    a.LineString = [
      new Bk({ stroke: new Ak({ color: b, width: 5 }) }),
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ha(this.G(), a, b)) return d;
    this.o != this.g &&
      ((this.D = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0))),
      (this.o = this.g));
  ...
  k.Tn = function (a, b) {
    return "XYM" != this.ja && "XYZM" != this.ja
      ? null
      : Sk(this.A, 0, this.A.length, this.a, a, void 0 !== b ? b : !1);
  };
  k.W = function () {
    return yf(this.A, 0, this.A.length, this.a);
  };
  ...
  function Uk(a, b, c) {
    for (
      ...
      (v = n.pop()),
        ...
        (r = a(A)),
        (u = b(r)),
        sa(u[0], u[1], g[0], g[1], h[0], h[1]) < c
          ? (d.push(h[0], h[1]), (f = z.toString()), (p[f] = !0))
          : (n.push(z, A, A, v), m.push(h, u, u, g), l.push(f, r, r, e));
    return d;
  }
    ...
    hb(h.G(), f) &&
      (a.b &&
        ...
        (f = [
          d[0],
          pa(
            f[1] + Math.abs(f[1] - f[3]) * a.ca,
            Math.max(f[1], d[1]),
            Math.min(f[3], d[d.length - 1])
          ),
        ]),
  ...
  function al(a, b, c, d, e, f, g) {
    ...
    hb(h.G(), f) &&
      (a.a &&
        ...
        (f = [
          pa(
            f[0] + Math.abs(f[0] - f[2]) * a.V,
            Math.max(f[0], d[0]),
            Math.min(f[2], d[d.length - 2])
          ),
          d[1],
        ]),
        (c = void 0 !== a.a[c] ? a.a[c].Qd : new C(null)),
        c.na(f),
        (a.a[g] = { Qd: c, text: a.Wa(b) })),
      (a.c[g++] = h));
    return g;
  }
  k = Xk.prototype;
  ...
  k.di = function (a) {
    ...
    b.Oa(null, this.ra);
    a = 0;
    for (c = this.g.length; a < c; ++a) (e = this.g[a]), b.Hb(e);
    a = 0;
  ...
  k.ln = function () {
    void 0 === this.resolution &&
      (this.resolution = db(this.extent) / this.M.height);
    this.state = 2;
    this.g.forEach(Gc);
    this.g = null;
    this.u();
  ...
  k.Oa = function (a, b) {
    ...
    a instanceof CanvasGradient || a instanceof CanvasPattern
      ? (a = tl)
      : (a =
          vi(a).map(function (a, b) {
            return 3 != b ? a / 255 : a;
          }) || tl);
    (this.c.strokeColor &&
      jc(this.c.strokeColor, c) &&
      this.c.fillColor &&
      jc(this.c.fillColor, a) &&
      this.c.lineWidth === b) ||
      ((this.c.u = !0),
      (this.c.fillColor = a),
  ...
  function Hl(a, b) {
    ...
    (this.f = ec(da, "OES_element_index_uint")) &&
  ...
  function rl(a, b, c) {
    ...
    if (f in a.a) d.bindBuffer(b, a.a[f].buffer);
      ...
      34962 == b
        ...
        : 34963 == b && (h = a.f ? new Uint32Array(e) : new Uint16Array(e));
  ...
  k.Od = function (a, b, c, d) {
    ...
    if (nb(c)) {
      ...
      for (f = g = 0, h = e.length; f < h; ++f) {
        ...
        for (
          var l = 0 < f ? d[f - 1] : 0, m = d[f], n = l;
          g < this.g.length && this.g[g] <= m;

        ) {
          var p = x(this.i[g]).toString();
          void 0 !== c[p]
            ? (n !== l && sl(a, b, n, l),
              (l = n = g === this.g.length - 1 ? m : this.g[g + 1]))
            : (l = g === this.g.length - 1 ? m : this.g[g + 1]);
          g++;
        }
        n !== l && sl(a, b, n, l);
      }
  ...
  k.Zb = function (a) {
    ...
    0 === this.c.length
      ? this.c.push(e)
      : ((n = this.c[this.c.length - 1]),
        x(n) != x(e) && (this.o.push(this.b.length), this.c.push(e)));
    this.D = b[0];
    this.C = b[1];
    this.height = m[1];
    this.oa = d[1];
  ...
  k.uc = function (a, b) {
    ...
    a = a.pa();
    fm(c, 0, c.length, a) &&
      ((c = Ue(c, 0, c.length, a, -this.origin[0], -this.origin[1])),
      this.c.u && (this.l.push(this.b.length), (this.c.u = !1)),
      this.g.push(this.b.length),
      this.i.push(b),
  ...
  k.vc = function (a, b) {
    ...
    this.b.length > c &&
      (this.g.push(c),
      this.i.push(b),
      this.c.u && (this.l.push(c), (this.c.u = !1)));
  };
  function gm(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (e = c.length; b < e; ++b)
        Rl(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])),
    ...
    if (nb(c)) {
      ...
      for (h = this.l.length - 1; 0 <= h; --h) {
        ...
        for (n = this.l[h]; 0 <= m && this.g[m] >= n; ) {
          ...
          q = x(q).toString();
          c[q] &&
            (g !== l && (sl(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT)), (l = p));
          m--;
          g = p;
        }
  ...
  function xm(a, b) {
    return a.a
      .search({ fa: b[0], ea: b[1], la: b[2], ka: b[3] })
      .map(function (a) {
        return a.value;
      });
  }
  ...
  function Bm(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        !n &&
          Gm(c, h[l].Ec[0], e, b[0], f) &&
          (f.concat(h[l].gh), Em(e, f, !1));
      }
    } else Em(e, f, !1);
    Hm(a, e, f);
  }
  ...
  function Em(a, b, c) {
    ...
    do {
      var h = c
        ? wl(f.X.x, f.X.y, e.X.x, e.X.y, e.Z.x, e.Z.y)
        : wl(e.Z.x, e.Z.y, e.X.x, e.X.y, f.X.x, f.X.y);
      void 0 === h
        ? (Km(e, f, a, b), (g = !0), f === d && (d = qm(a)), (f = e), rm(a))
        : e.X.Kb !== h && ((e.X.Kb = h), (g = !0));
      e = f;
      f = pm(a);
    } while (e !== d);
    return g;
    ...
    if (0 < g && ((f = Mm(b, r, f.X, e)), f.length))
      for (r = Infinity, m = 0, h = f.length; m < h; ++m)
        if (
          ...
          (r = n), (l = g);
    for (f = om(c); f.X.x !== l.x || f.X.y !== l.y; ) f = pm(c);
  ...
  function Om(a, b, c, d, e) {
    ...
    do {
      ...
      if (!1 === r.Kb) {
        var v = d
          ? 0 === Mm(q, r, u, c, !0).length
          : e
          ? Qm(n.X, u, r, q, h.Z)
          : Qm(h.Z, q, r, u, n.X);
        (!d && 0 !== Fm({ Z: q, X: u }, c).length) ||
          !v ||
          (!d &&
            !1 !== q.Kb &&
            !1 !== u.Kb &&
            Mf(
              [h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y],
              0,
              10,
              2
            ) !== !e) ||
  ...
  function Pm(a, b, c, d) {
    ...
    do {
      ...
      if (l) {
        ...
        d
          ? (l[0] === f.Z.x && l[1] === f.Z.y
              ? (rm(b), (l = f.Z), (g.Z = l), c.remove(f), (p = p || f === e))
              : ((l = g.X), (f.X = l), c.remove(g), (p = p || g === e)),
            nm(b))
          : ((l = Im(a, l[0], l[1], m)),
            (f.X = l),
            (g.Z = l),
    ...
    for (f = l.length; d < f; ++d)
      for (g in l[d]) {
        ...
        "object" !== typeof m ||
          ...
          (m.x === c.x && m.y === c.y) ||
          -1 !== h.indexOf(m) ||
          !Gf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, m.x, m.y) ||
          h.push(m);
      }
    return h;
  }
  ...
  k.xc = function (a, b) {
    ...
    this.b.length > e &&
      (this.g.push(e),
      this.i.push(b),
      this.l.u && (this.c.push(e), (this.l.u = !1)));
  ...
  k.Oa = function (a, b) {
    ...
    (this.l.fillColor && jc(a, this.l.fillColor)) ||
      ((this.l.fillColor = a), (this.l.u = !0), this.o.push(a));
    b
      ? this.f.Oa(null, b)
      : this.f.Oa(null, new Ak({ color: [0, 0, 0, 0], lineWidth: 0 }));
  };
  function Rm(a, b) {
    this.b = b;
  ...
  Rm.prototype.add = function (a, b, c, d, e) {
    ...
    for (f = this.a.length; g < f; ++g) {
      ...
      if (h.width >= b + this.b && h.height >= c + this.b)
        return (
          (f = { offsetX: h.x + this.b, offsetY: h.y + this.b, image: this.i }),
          (this.c[a] = f),
          ...
          h.width - b > h.height - d
            ? ((c = {
              ...
              (b = { x: h.x, y: h.y + d, width: b, height: h.height - d }),
              Sm(this, a, c, b))
            : ((c = { x: h.x + b, y: h.y, width: h.width - b, height: d }),
              (b = {
                x: h.x,
                y: h.y + d,
                width: h.width,
  ...
  function Wm(a, b, c, d, e, f, g) {
    ...
    for (l = h.length; m < l; ++m) {
      ...
      n ||
        m !== l - 1 ||
        (b
          ? ((n = Math.min(2 * a.c, a.g)), (a.c = n))
          : ((n = Math.min(2 * a.a, a.g)), (a.a = n)),
        (n = new Rm(n, a.b)),
        h.push(n),
        ++l);
    }
      ...
      for (g = b.length; f < g; ++f) {
        ...
        for (h = r.length; u < h; ++u) {
          ...
          if (v) {
            ...
            this.width =
              0 === u || u === r.length - 1 ? a.width[r[u]] + n : a.width[r[u]];
            this.oa = A.height;
            this.qa = A.width;
            0 === this.c.length
              ? this.c.push(A)
              : ((v = this.c[this.c.length - 1]),
                x(v) != x(A) && (this.v.push(this.b.length), this.c.push(A)));
            v = c;
            z = d;
            var E = e;
  ...
  function Zm(a, b) {
    if (1 === b.length) {
      ...
      c.Bh.add(b, a, c.height, function (a, c, g) {
        ...
        od &&
          d.lineDash &&
          (a.setLineDash(d.lineDash), (a.lineDashOffset = d.lineDashOffset));
    ...
    if (a && a.Ka() && (c || d)) {
      ...
      d
        ? ((c = d.a),
          ...
          (b.miterLimit = d.l || 10),
          (d = d.g),
          (b.lineDash = d ? d.slice() : ul))
        : ((b.strokeColor = null), (b.lineWidth = 0));
      ...
      e = c;
      this.B[e] ||
        ((a = this.Ub.getContext("2d")),
        (a.font = b.font),
        (a = Math.ceil(
          (1.5 * a.measureText("M").width + b.lineWidth / 2) * b.scale
        )),
        (this.B[e] = {
  ...
  function tn(a, b, c, d) {
    ...
    if (a.a.a.hasOwnProperty(f))
      (a = a.a.get(f)),
        ...
        9729 != a.hi && (e.texParameteri(3553, 10240, 9729), (a.hi = 9729)),
        9729 != a.ji && (e.texParameteri(3553, 10241, 9729), (a.ji = 9729));
    else {
  ...
  k.bh = function (a) {
    ...
    0 !== this.j.b.length &&
      (a.postRenderFunctions.push(this.B), (a.animate = !0));
  ...
  k.Bg = function (a, b, c) {
      ...
      for (xa = b.length; ia < xa; ++ia)
        for (Z in ((Va = c[b[ia]]), Va))
          (ta = Va[Z]),
            ...
            e.drawArrays(5, 0, 4);
      Ia
        ? ((this.l = E), (this.D = u), (this.s = l.g))
        : ((this.D = this.l = null), (this.s = -1), (a.animate = !0));
    }
    ...
    Wi(
      ...
      function (a) {
        2 != a.getState() ||
          d.a.a.hasOwnProperty(a.lb()) ||
          a.lb() in Zb.a ||
          Zb.i([a, yc(m, a.ya), m.Ta(a.ya[0]), q, v * r]);
      },
      this
    );
    Ti(a, l);
    ...
    df(
      e,
      (Math.round(z[0] / p) * p - u[0]) / (u[2] - u[0]),
      (Math.round(z[1] / p) * p - u[1]) / (u[3] - u[1])
    );
  ...
  k.km = function () {
    ...
    a &&
      ...
      this.insertFirst
        ? a.insertBefore(this.element, a.childNodes[0] || null)
  ...
  function Jn(a, b) {
    a.a.visible !== b &&
      ((a.element.style.display = b ? "" : "none"), (a.a.visible = b));
  }
  function Hn(a) {
    var b = a.Ve(),
      c = a.pi();
  ...
  k.load = function () {
    0 == this.state &&
      (oj(this, 1), this.C(this, this.N), this.D(null, NaN, null));
  };
  k.Cp = function (a, b, c) {
    this.vg(b);
    this.Ij(a);
  ...
  function Mn(a) {
    ...
    c = document.createElement("div");
    c.className =
      this.c + " ol-unselectable ol-control " + (On() ? "" : "ol-unsupported");
    c.appendChild(b);
    vg.call(this, { element: c, target: a.target });
  ...
  Mn.prototype.o = function () {
    var a = this.element.firstElementChild,
      b = this.a;
    Nn()
      ? ((a.className = this.c + "-true"), ig(this.v, this.l))
      : ((a.className = this.c + "-false"), ig(this.l, this.v));
    b && b.Oc();
  };
  ...
  function Sn(a) {
    ...
    a
      ? this.c != a.viewState.projection &&
        ((this.c = a.viewState.projection), (this.j = null))
      : (this.c = null);
    Un(this, this.l);
  }
  k = Rn.prototype;
  ...
  k.setMap = function (a) {
    ...
    a &&
      ((a = a.a),
      this.s.push(
        y(a, "mousemove", this.mm, this),
        y(a, "mouseout", this.nm, this)
      ));
  };
  k.Gj = function (a) {
    this.set(Vn, a);
  ...
  function Wn(a) {
    ...
    "string" === typeof f
      ? ((this.o = document.createElement("span")), (this.o.textContent = f))
      : (this.o = f);
    f = void 0 !== a.label ? a.label : "\u00bb";
    "string" === typeof f
      ? ((this.D = document.createElement("span")), (this.D.textContent = f))
      : (this.D = f);
  ...
  k.setMap = function (a) {
    ...
    a !== b &&
      (b &&
        ((b = b.aa()) && Mc(b, Xc("rotation"), this.Qe, this), this.c.Ad(null)),
      vg.prototype.setMap.call(this, a),
      a &&
        (this.c.Ad(this.C),
        ...
        (a = a.aa()))) &&
      (y(a, Xc("rotation"), this.Qe, this), ag(a) && (this.c.Oc(), Yn(this)));
  };
  k.lm = function (a) {
    "view" === a.key &&
      ((a = a.oldValue) && Mc(a, Xc("rotation"), this.Qe, this),
      (a = this.a.aa()),
  ...
  function Xn() {
    ...
    if (a.c && b.c) {
      ...
      b < 0.1 * f || e < 0.1 * d || b > 0.75 * f || e > 0.75 * d
        ? Yn(this)
        : La(c, a) || ((a = this.c), (c = this.a.aa()), a.aa().ub(c.xa()));
    }
    Zn(this);
  }
  function Yn(a) {
  ...
  function io(a) {
    if (a.frameState) {
      if (!this.$) {
        ...
        b =
          e.offsetWidth + parseFloat(f.marginRight) + parseFloat(f.marginLeft);
        e =
          e.offsetHeight + parseFloat(f.marginTop) + parseFloat(f.marginBottom);
        this.O = [b, e];
        c > d
          ? ((this.j = 1), (this.D = c - b))
          : ((this.j = ho), (this.v = d - e));
        this.$ = !0;
      }
  ...
  k.Xl = function (a) {
    ...
    a = ko(
      ...
      pa(
        1 === this.j
          ? (a.offsetX - this.O[0] / 2) / this.D
          : (a.offsetY - this.O[1] / 2) / this.v,
        0,
        1
      )
    );
  ...
  k.Yl = function (a) {
    if (this.o) {
      ...
      this.c = ko(
        ...
        pa(
          1 === this.j
            ? (a.clientX - this.C + parseInt(b.style.left, 10)) / this.D
            : (a.clientY - this.B + parseInt(b.style.top, 10)) / this.v,
          0,
          1
        )
      );
  ...
  function po(a, b, c) {
    if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE)
      b
        ...
        : c.push(a.nodeValue);
    else for (a = a.firstChild; a; a = a.nextSibling) po(a, b, c);
    return c;
  }
  function qo(a) {
      ...
      h.onload = function () {
        if (!h.status || (200 <= h.status && 300 > h.status)) {
          ...
          if ("json" == a || "text" == a) var e = h.responseText;
            ...
            "xml" == a
              ? (e = h.responseXML) || (e = so(h.responseText))
              : "arraybuffer" == a && (e = h.response);
          e
            ? c.call(this, b.Qa(e, { featureProjection: g }), b.sb(e), b.cg())
            : d.call(this);
        } else d.call(this);
      }.bind(this);
      h.onerror = function () {
  ...
  function Io(a, b) {
    return kb(
      { dataProjection: a.defaultDataProjection, featureProjection: a.i },
      b
    );
  }
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ha(this.G(), a, b)) return d;
    this.j != this.g &&
      ((this.o = Math.sqrt(qf(this.A, 0, this.c, this.a, 0))),
      (this.j = this.g));
    return uf(this.A, 0, this.c, this.a, this.o, !1, a, b, c, d);
  };
  k.Wn = function (a, b, c) {
    return ("XYM" != this.ja && "XYZM" != this.ja) || 0 === this.A.length
      ? null
      : Tk(
          this.A,
          this.c,
  ...
  k.clone = function () {
    for (
      var a = new Q(null), b = this.c.length, c = Array(b), d = 0;
      d < b;
      ++d
    )
      c[d] = this.c[d].slice();
  ...
  k.Tg = function (a) {
    return a.spatialReference && a.spatialReference.wkid
      ? Ob("EPSG:" + a.spatialReference.wkid)
      : null;
  };
  function Vo(a, b) {
    ...
    if ("FeatureCollection" == c)
      ...
      for (var u in g) {
        ...
        for (h = f.length; l < h; ++l)
          (-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u &&
            (n[f[l].split(":").pop()] =
              "featureMembers" == c ? uo(this.Kg, this) : vo(this.Kg, this));
        e[g[u]] = n;
      }
  ...
  k.Kg = function (a, b) {
    var c;
    (c = a.getAttribute("fid")) ||
      (c = a.getAttributeNS("http://www.opengis.net/gml", "id") || "");
    var d = {},
      e;
    for (a = a.firstElementChild; a; a = a.nextElementSibling) {
      ...
      if (
        ...
        (1 === a.childNodes.length &&
          (3 === a.firstChild.nodeType || 4 === a.firstChild.nodeType))
      ) {
        var g = oo(a, !1);
        $o.test(g) && (g = void 0);
        d[f] = g;
  ...
  k.Pg = function (a, b) {
    ...
    a.getAttribute("srsDimension")
      ? (d = gp(a.getAttribute("srsDimension")))
      : a.getAttribute("dimension")
      ? (d = gp(a.getAttribute("dimension")))
      : a.parentNode.getAttribute("srsDimension")
      ? (d = gp(a.parentNode.getAttribute("srsDimension")))
      : e && (d = gp(e));
  ...
  k.nk = {
    "http://www.opengis.net/gml": { PolygonPatch: vo(Kp.prototype.gq) },
  };
  k.rk = {
    "http://www.opengis.net/gml": { LineStringSegment: vo(Kp.prototype.$p) },
  };
  function Lp(a, b, c) {
    var d = c[c.length - 1];
    c = d.hasZ;
  ...
  var Mp = {
    "http://www.opengis.net/gml": { lowerCorner: M(ip), upperCorner: M(ip) },
  };
  k = Kp.prototype;
  k.Pn = function (a, b, c) {
    var d = c[c.length - 1].srsName;
  ...
  k.af = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((b = b.Ud()),
        Do({ node: a, hasZ: e, srsName: d }, Np, this.On, b, c, void 0, this))
      : "Surface" === a.nodeName &&
        ((e = no(a.namespaceURI, "patches")),
        a.appendChild(e),
  ...
  k.$e = function (a, b, c) {
    ...
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((d = no(a.namespaceURI, "posList")), a.appendChild(d), Lp(d, b, c))
      : "Curve" === a.nodeName &&
        ((d = no(a.namespaceURI, "segments")),
        a.appendChild(d),
  ...
  k.Gi = function (a, b, c) {
    ...
    b = b.Vd();
    Do(
      { node: a, hasZ: e, srsName: f, surface: d },
      Op,
      this.l,
      b,
      c,
  ...
  k.Fi = function (a, b, c) {
    ...
    b = b.wd();
    Do(
      { node: a, hasZ: e, srsName: f, curve: d },
      Qp,
      this.l,
      b,
      c,
  ...
  k.Yc = function (a, b, c) {
    ...
    Array.isArray(b)
      ? d.dataProjection
        ? (f = bc(b, d.featureProjection, d.dataProjection))
        : (f = b)
      : (f = Jo(b, !0, d));
  ...
  k.Ci = function (a, b, c) {
    ...
    for (m in g) {
      ...
      null !== l &&
        ...
        h.push(l),
        m == f || l instanceof gf
          ? m in d.tb[e] || (d.tb[e][m] = M(this.Yc, this))
          : m in d.tb[e] || (d.tb[e][m] = M(ip)));
    }
    var m = kb({}, d);
    m.node = a;
    ...
    Array.isArray(a)
      ...
      : ((a = a.S()),
        "MultiPolygon" === a && !0 === b
          ...
          : "LineString" === a && !0 === e
          ? (a = "Curve")
          : "MultiLineString" === a && !0 === c && (a = "MultiCurve"));
  ...
  k.Ye = function (a, b, c) {
    ...
    "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((d = Vp(a.namespaceURI)), a.appendChild(d), Wp(d, b, c))
      : "Curve" === a.nodeName &&
        ((d = no(a.namespaceURI, "segments")),
        a.appendChild(d),
        (a = no(d.namespaceURI, "LineStringSegment")),
  ...
  k.Ze = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((b = b.Ud()),
        Do({ node: a, hasZ: e, srsName: d }, Yp, this.Kn, b, c, void 0, this))
      : "Surface" === a.nodeName &&
        ((e = no(a.namespaceURI, "patches")),
        a.appendChild(e),
        (a = no(e.namespaceURI, "PolygonPatch")),
  ...
  k.Kn = function (a, b) {
    ...
    return no(
      b.namespaceURI,
      void 0 !== c ? "innerBoundaryIs" : "outerBoundaryIs"
    );
  };
  k.Ai = function (a, b, c) {
    var d = no(a.namespaceURI, "LinearRing");
  ...
  function mq(a, b) {
    var c = b[0];
    if (
      (a = O({ flatCoordinates: [], ends: [], layoutOptions: {} }, nq, a, b))
    ) {
      b = a.flatCoordinates;
      delete a.flatCoordinates;
      var d = a.ends;
  ...
  var qq = { rte: kq, trk: mq, wpt: oq },
    ...
    lq = N(eq, {
      ...
      rtept: function (a, b) {
        var c = O({}, sq, a, b);
        c &&
          ((b = b[b.length - 1]), fq(b.flatCoordinates, b.layoutOptions, a, c));
      },
    }),
  ...
  dq.prototype.Kc = function (a, b) {
    return ec(eq, a.namespaceURI)
      ? "gpx" == a.localName && (a = O([], rq, a, [Ho(this, a, b)]))
        ? (vq(this, a), a)
        : []
      : [];
  };
  ...
  var yq = ["text", "type"],
    ...
    Iq = N(eq, {
      ...
      trkseg: xo(
        M(function (a, b, c) {
          Do(
            { node: a, geometryLayout: b.ja, properties: {} },
            Gq,
            Hq,
            b.W(),
            c
  ...
  k.Wd = function (a) {
    ...
    if (e)
      return (
        (a = new Mq(null)), Pq(a), (a.a = c), Nq(a), a.u(), (this.i[b] = a)
      );
    this.f = a;
    return this;
  };
  ...
  var Sq = {
    ...
    Uq = {
      ...
      LineString: function (a) {
        return { type: "LineString", coordinates: a.W() };
      },
  ...
  k.dd = function (a, b) {
    ...
    this.b
      ? c.Lc(this.b)
      : this.a && void 0 !== a.geometry_name && c.Lc(a.geometry_name);
    c.Va(b);
      ...
      if ("B" == p.charAt(0)) {
        ...
        "H" == p.charAt(0) &&
          ((q = $q.exec(p))
            ? ((h = parseInt(q[1], 10)),
              (g = parseInt(q[2], 10) - 1),
              (f = 2e3 + parseInt(q[3], 10)))
            : (q = Zq.exec(p)) && (a[q[1]] = q[2].trim()));
    }
  ...
  function dr(a) {
    a = a || {};
    this.l = void 0 !== a.anchor ? a.anchor : [0.5, 0.5];
    this.o = null;
  ...
  function er(a) {
    ...
    fr ||
      ...
      (pr = "NO_IMAGE"),
      (qr = new Ak({ color: gr, width: 1 })),
      (rr = new Ak({ color: [51, 51, 51, 1], width: 2 })),
      (sr = new J({
      ...
      (tr = new Bk({ fill: hr, image: or, text: sr, stroke: qr, zIndex: 0 })),
      (fr = [tr]));
    this.defaultDataProjection = Ob("EPSG:4326");
  ...
  function Mr(a, b) {
    ...
    if (c)
      if ("Point" == d) {
        ...
        "LineString" == d
          ? ((g = new P(null)), Mo(g, a), Or(g, a))
          : "Polygon" == d
          ? ((g = new Q(null)), Oo(g, a), Or(g, a))
  ...
  var Yr = N(vr, { displayName: L(R), value: L(R) }),
    Vr = N(vr, {
      Data: function (a, b) {
        ...
        null !== c
          ? (a[c] = a.value)
          : null !== a.displayName && (a[a.displayName] = a.value);
        delete a.value;
      },
      ...
      N(ur, {
        coord: function (a, b) {
          ...
          (a =
            ...
            ? b.push(parseFloat(a[1]), parseFloat(a[2]), parseFloat(a[3]), 0)
            : b.push(0, 0, 0, 0);
        },
      })
    ),
    ...
    ds = N(
      vr,
      { href: L(Cr) },
      N(ur, { x: L(dp), y: L(dp), w: L(dp), h: L(dp) })
    ),
    es = N(vr, {
      Icon: L(function (a, b) {
    ...
    Tr = N(vr, {
      IconStyle: function (a, b) {
        if ((a = O({}, es, a, b))) {
          ...
          if (g) {
            ...
            e === mr
              ? ((h = ir), (l = kr), (m = jr))
              : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) &&
                ((h = [0.5, 0]), (m = l = "fraction"));
          var n;
          g = c.x;
          var p = c.y;
      ...
      LineStyle: function (a, b) {
        (a = O({}, gs, a, b)) &&
          (b[b.length - 1].strokeStyle = new Ak({
  ...
  k.Lg = function (a, b) {
    return ec(vr, a.namespaceURI)
      ? (a = this.Rg(a, [Ho(this, a, b)]))
        ? a
        : null
      : null;
  };
  ...
  k.eq = function (a) {
    ...
    qo(a)
      ...
      : ro(a)
      ? gc(b, rs(this, a))
      : "string" === typeof a && ((a = so(a)), gc(b, qs(this, a)));
    return b;
  };
  function qs(a, b) {
    var c = [];
  ...
  k.hq = function (a) {
    ...
    qo(a)
      ...
      : ro(a)
      ? gc(b, this.vf(a))
      : "string" === typeof a && ((a = so(a)), gc(b, ss(this, a)));
    return b;
  };
  function ss(a, b) {
    var c = [];
  ...
  var Ps = N(vr, ["Document", "Placemark"]),
    ...
    Ts = N(vr, {
      Data: M(function (a, b, c) {
        ...
        "object" == typeof b
          ? (null !== b &&
              b.displayName &&
              Do(a, Ts, Ao, [b.displayName], c, ["displayName"]),
            null !== b && b.value && Do(a, Ts, Ao, [b.value], c, ["value"]))
          : Do(a, Ts, Ao, [b], c, ["value"]);
      }),
    ...
    Ws = N(
      vr,
      { href: M(ip) },
      N(ur, { x: M(Ip), y: M(Ip), w: M(Ip), h: M(Ip) })
    ),
    ...
    Es = N(vr, {
      ExtendedData: M(function (a, b, c) {
        ...
        for (var e = d.length, f = 0; f < e; f++)
          Do(a, Ts, dt, [{ name: d[f], value: b[f] }], c);
      }),
      MultiGeometry: M(us),
      LineString: M(Hs),
      LinearRing: M(Hs),
  ...
  (function (a) {
      ...
      write: function (a, b, c, d, e, n) {
        ...
        isNaN(b) || Infinity === b
          ...
          : ((d = Math.floor(Math.log(b) / Math.LN2)),
            1 > b * (f = Math.pow(2, -d)) && (d--, (f *= 2)),
            (b = 1 <= d + l ? b + m / f : b + m * Math.pow(2, 1 - l)),
            2 <= b * f && (d++, (f /= 2)),
            d + l >= h
              ? ((b = 0), (d = h))
              : 1 <= d + l
              ? ((b = (b * f - 1) * Math.pow(2, e)), (d += l))
              : ((b = b * Math.pow(2, l - 1) * Math.pow(2, e)), (d = 0)));
    ...
    b.prototype = {
      ...
      Vg: function () {
        for (
          var a = this.Ua() + this.ga, b = this.tc, c = "", d = this.ga;
          d < a;
          ...
          if (1 === p) 128 > e && (n = e);
            ...
            var q = b[d + 1];
            128 === (q & 192) &&
              ((n = ((e & 31) << 6) | (q & 63)), 127 >= n && (n = null));
          } else if (3 === p) {
            q = b[d + 1];
            var r = b[d + 2];
            128 === (q & 192) &&
              128 === (r & 192) &&
              ((n = ((e & 15) << 12) | ((q & 63) << 6) | (r & 63)),
              2047 >= n || (55296 <= n && 57343 >= n)) &&
              (n = null);
          } else if (4 === p) {
            q = b[d + 1];
            r = b[d + 2];
      ...
      Lq: function (a) {
        a &= 7;
        if (a === b.c) for (; 127 < this.tc[this.ga++]; );
  ...
  k.G = function () {
    this.i ||
      (this.i =
        "Point" === this.f ? Pa(this.b) : Qa(this.b, 0, this.b.length, 2));
    return this.i;
  };
  k.Td = function () {
    if (!this.c) {
    ...
    for (var m = 1, n = 0, p = 0, q = 0, r = 0, u = 0; b.ga < c; )
      n || ((n = b.Ua()), (m = n & 7), (n >>= 3)),
        ...
        1 === m || 2 === m
          ? ((p += b.Ug()),
            (q += b.Ug()),
            1 === m && r > u && (l.push(r), (u = r)),
            g.push(p, q),
            (r += 2))
          : 7 === m
          ? r > u && (g.push(g[u], g[u + 1]), (r += 2))
          : oa(!1, 59);
    r > u && l.push(r);
    b = h.length;
    var v;
    1 === d
      ? (v = 1 === b ? "Point" : "MultiPoint")
      : 2 === d
      ? (v = 1 === b ? "LineString" : "MultiLineString")
      : 3 === d && (v = "Polygon");
    d = v;
    if (a.b === it) g = new a.b(d, g, h, f, e);
    else {
      if ("Polygon" == d) {
        d = [];
        l = b = v = 0;
        for (c = h.length; l < c; ++l)
          (m = h[l]),
            Mf(g, v, m, 2) || (d.push(h.slice(b, l)), (b = l)),
            (v = m);
    ...
    if ("osm" == a.localName) {
      ...
      for (var c = 0; c < a.lh.length; c++) {
        for (var d = a.lh[c], e = [], f = 0, g = d.zd.length; f < g; f++)
          gc(e, a.ki[d.zd[f]]);
        d.zd[0] == d.zd[d.zd.length - 1]
          ? ((f = new D(null)), f.ba("XY", e, [e.length]))
          : ((f = new I(null)), f.ba("XY", e));
        Jo(f, !1, b);
        e = new Hk(f);
        e.qc(d.id);
        e.H(d.le);
  ...
  At.prototype.Mg = function (a, b) {
    if ("Topology" == a.type) {
      ...
      g = this.a;
      for (var A in a)
        (this.b && -1 == this.b.indexOf(A)) ||
          ("GeometryCollection" === a[A].type
            ? ((l = a[A]), e.push.apply(e, Ct(l, f, c, d, g, A, b)))
            : ((l = a[A]), e.push(Dt(l, f, c, d, g, A, b))));
      return e;
    }
    return [];
  };
  ...
  var ju = {
    "http://www.opengis.net/gml": { boundedBy: L(Zo.prototype.rf, "bounds") },
  };
  function iu(a, b) {
    var c = {},
  ...
  var qu = {
    "http://www.opengis.net/wfs": {
        ...
        if (2 === e) {
          ...
          for (n in h) {
            ...
            null !== m &&
              ...
              l.push(m),
              n == g || m instanceof gf
                ? n in e.tb[f] || (e.tb[f][n] = M(a.ui, a))
                : n in e.tb[f] || (e.tb[f][n] = M(ip)));
          }
          var n = kb({}, e);
          n.node = d;
          Do(n, e.tb, yo(void 0, f), l, c, b);
        } else Kp.prototype.Ci(d, b, c);
      }),
      ...
      Property: M(function (a, b, c) {
        ...
        void 0 !== b.value &&
          null !== b.value &&
          ((d = no("http://www.opengis.net/wfs", "Value")),
          a.appendChild(d),
          b.value instanceof gf
            ? 2 === e
              ? Tp.prototype.ui(d, b.value, c)
              : Kp.prototype.Yc(d, b.value, c)
            : ip(d, b.value));
      }),
  ...
  function kv(a, b) {
    if ((b = gv(a, b)))
      return (
        (a = [gp(a.getAttribute("width")), gp(a.getAttribute("height"))]),
        (b.size = a),
        b
      );
  }
  ...
  var Vv = [null, "http://www.opengis.net/wmts/1.0"],
    ...
    Yv = N(
      Vv,
      {
        Style: wo(function (a, b) {
          if ((b = O({}, $v, a, b)))
            return (
              (a = "true" === a.getAttribute("isDefault")), (b.isDefault = a), b
            );
        }),
        Format: wo(R),
    ...
    Zv = N(
      ...
      N(Wv, { SupportedCRS: L(R), Identifier: L(R) })
    ),
    fw = N(
      Vv,
      {
  ...
  function qw(a) {
    return dh(a) && this.s(a)
      ? (bg(a.map.aa(), 1, 1), (this.a = this.f = void 0), !0)
      : !1;
  }
  function T(a) {
    a = a ? a : {};
  ...
  function U(a) {
    ...
    void 0 !== a.loader
      ? (this.o = a.loader)
      : void 0 !== this.V && (oa(this.O, 7), (this.o = Fo(this.V, this.O)));
  ...
  function xw(a, b) {
    ...
    for (c = e.length; g < c; g++)
      (h = e[g]),
        (l = x(h).toString()),
        Aw(a, l, h),
        (b = h.U()) ? ((l = b.G()), d.push(l), f.push(h)) : (a.f[l] = h);
    a.a && a.a.load(d, f);
    g = 0;
  ...
  k.gj = function (a) {
    ...
    c
      ? ((c = c.G()),
        b in this.f
          ? (delete this.f[b], this.a && this.a.Ca(c, a))
          : this.a && vm(this.a, c, a))
      : b in this.f || (this.a && this.a.remove(a), (this.f[b] = a));
    c = a.c;
    void 0 !== c
      ? ((c = c.toString()),
        b in this.l
          ? (delete this.l[b], (this.j[c] = a))
          : this.j[c] !== a && (Dw(this, a), (this.j[c] = a)))
      : b in this.l || (Dw(this, a), (this.l[b] = a));
    this.u();
  ...
  function Gw(a) {
    ...
    var b = !0;
    this.o && "pointerdrag" === a.type && null !== this.j
      ? (Nw(this, a), (b = !1))
      : this.o && "pointerdown" === a.type
      ? (b = !1)
      : "pointermove" === a.type
      ? (b = Ow(this, a))
      : "dblclick" === a.type && (b = !1);
  ...
  function Fw(a) {
    this.V = !this.o;
    return this.o
      ? ((this.ca = a.pixel), this.s || Pw(this, a), !0)
      : this.Wk(a)
      ? ((this.ca = a.pixel), !0)
      : !1;
  }
    ...
    this.V
      ? (this.s
          ? this.o || c
            ...
            ? this.Md(a) && this.Pd()
            : Nw(this, a)
          : (Pw(this, a), this.f === Kw && this.Pd()),
        (b = !1))
      : this.o && ((this.s = null), Sw(this));
    ...
    a.s
      ? ((e = b.coordinate),
        ...
        a.f === Kw
          ? (d = a.a)
          : a.f === Jw
          ? ((d = a.a[0]), (d = d[d.length - 1]), Rw(a, b) && (e = a.s.slice()))
          : ((d = a.a), (d = d[d.length - 1])),
        (d[0] = e[0]),
        (d[1] = e[1]),
        a.cb(a.a, c),
        a.B && a.B.U().na(e),
        c instanceof D && a.f !== Jw
          ? (a.C || (a.C = new Hk(new I(null))),
            (e = c.Wh(0)),
            (b = a.C.U()),
            b.ba(e.ja, e.da()))
          : a.T && ((b = a.C.U()), b.na(a.T)),
        Tw(a))
      : ((b = b.coordinate.slice()),
        a.B ? a.B.U().na(b) : ((a.B = new Hk(new C(b))), Tw(a)));
    return !0;
  }
  function Rw(a, b) {
    var c = !1;
  ...
  function Pw(a, b) {
    ...
    a.f === Kw
      ? (a.a = b.slice())
      : a.f === Jw
      ? ((a.a = [[b.slice(), b.slice()]]), (a.T = a.a[0]))
      : ((a.a = [b.slice(), b.slice()]), a.f === Qw && (a.T = a.a));
  ...
  k.Pd = function () {
    ...
    this.f === Lw
      ? (b.pop(), this.cb(b, c))
      : this.f === Jw && (b[0].pop(), this.cb(b, c), (b = c.W()));
    "MultiPoint" === this.O
      ? a.Va(new No([b]))
      : "MultiLineString" === this.O
      ? a.Va(new P([b]))
      : "MultiPolygon" === this.O && a.Va(new Q([b]));
    ...
    (a = bx(this, c, d)) && e
      ? ((c = a[0] == e[0] || a[0] == e[2] ? a[0] : null),
        ...
        null !== c && null !== d
          ? (this.a = dx(b(a)))
          : null !== c
          ? (this.a = ex(b([c, e[1]]), b([c, e[3]])))
          : null !== d && (this.a = ex(b([e[0], d]), b([e[2], d]))))
      : ((a = d.Ra(c)), this.f([a[0], a[1], a[0], a[1]]), (this.a = dx(a)));
    return !0;
  }
  function Xw(a) {
  ...
  Vw.prototype.f = function (a) {
    ...
    b
      ? a
        ? b.Va(Rf(a))
        : b.Va(void 0)
      : ((this.s = b = a ? new Hk(Rf(a)) : new Hk({})), this.o.ha().Gb(b));
  ...
  function gx(a) {
    ...
    a.source
      ? ((this.V = a.source),
        ...
        y(this.V, "removefeature", this.xm, this))
      : (a = a.features);
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        if ("Circle" === l.geometry.S() && 1 === l.index)
          (m = tx(b, l)),
            Ee(m, c) && !f[n][0] && (this.j.push([l, 0]), (f[n][0] = l));
        else if (Ee(m[0], c) && !f[n][0]) this.j.push([l, 0]), (f[n][0] = l);
        else if (Ee(m[1], c) && !f[n][1]) {
          if (
            ("LineString" !== l.geometry.S() &&
              "MultiLineString" !== l.geometry.S()) ||
            !f[n][0] ||
            0 !== f[n][0].index
          )
  ...
  function jx(a) {
    ...
    a.map.aa().Vh() ||
      "pointermove" != a.type ||
      this.D ||
      ((this.Ea = a.pixel), mx(this, a.pixel, a.map));
    this.f &&
      this.ob(a) &&
      (b = "singleclick" == a.type && this.T ? !0 : this.Dj());
      ...
      if (n <= a.ra) {
        ...
        if ("Circle" === g.geometry.S() && 1 === g.index) (a.ua = !0), rx(a, l);
          ...
          for (
            ...
            if (
              ((l = f[m].ma),
              (Ee(h[0], l[0]) && Ee(h[1], l[1])) ||
                (Ee(h[0], l[1]) && Ee(h[1], l[0])))
            )
              b[x(l)] = !0;
            else break;
        b[x(h)] = !0;
  ...
  function ux(a, b) {
    var c = b.geometry;
    return "Circle" === c.S() && 1 === b.index
      ? ((a = He(c.xa(), a)), (c = Math.sqrt(a) - c.Bd()), c * c)
      : Je(a, b.ma);
  }
  function tx(a, b) {
    var c = b.geometry;
  ...
  k.Em = function (a, b) {
    for (
      var c = a.ma, d = a.feature, e = a.geometry, f = a.depth, g = a.index, h;
      b.length < e.pa();
  ...
  k.Dj = function () {
    if (this.O && "pointerdrag" != this.O.type) {
      ...
      for (e = b.length - 1; 0 <= e; --e) {
        ...
        h in c || (c[h] = {});
        0 === f[1]
          ? ((c[h].right = g), (c[h].index = g.index))
          : 1 == f[1] && ((c[h].left = g), (c[h].index = g.index + 1));
      }
      for (h in c) {
        var l = c[h].right;
        var m = c[h].left;
          ...
          case "Polygon":
            (p = p[g.depth[0]]),
              4 < p.length &&
                ...
                p.splice(e, 1),
                (q = !0),
                0 === e && (p.pop(), p.push(p[0]), (n = p.length - 1)));
        }
        q &&
          ((q = f),
          (this.s = !0),
          ...
          (this.s = !1),
          (d = []),
          void 0 !== m && (this.a.remove(m), d.push(m.ma[0])),
          void 0 !== l && (this.a.remove(l), d.push(l.ma[1])),
          void 0 !== m &&
            void 0 !== l &&
            ((m = {
              depth: g.depth,
          ...
          this.f && (this.B.ha().Lb(this.f), (this.f = null)),
          (b.length = 0));
      }
  ...
  function vx(a, b, c, d, e) {
    zm(a.a, b.G(), function (a) {
      a.geometry === b &&
        (void 0 === d || void 0 === a.depth || jc(a.depth, d)) &&
        a.index > c &&
        (a.index += e);
    });
  }
  ...
  function xx(a) {
    ...
    if (e) {
      ...
      f.Tc(
        ...
        { layerFilter: this.o, hitTolerance: this.j }
      );
      for (e = g.kc() - 1; 0 <= e; --e) {
        f = g.item(e);
        var m = l.indexOf(f);
          ...
          if (this.l(a, e))
            return (
              (!b && !d) || ec(g.a, a)
                ? (c || d) &&
                  ec(g.a, a) &&
                  (h.push(a), (e = x(a)), delete this.a[e])
                : (l.push(a), (a = x(a)), (this.a[a] = e)),
              !this.s
            );
        }.bind(this),
        { layerFilter: this.o, hitTolerance: this.j }
  ...
  k.setMap = function (a) {
    ...
    a &&
      (this.j
        ? c.push(
            y(this.j, "add", this.Ni, this),
            y(this.j, "remove", this.Oi, this)
          )
        : this.s &&
          c.push(
            y(this.s, "addfeature", this.Ni, this),
            y(this.s, "removefeature", this.Oi, this)
          ),
  ...
  function Jx(a) {
    var b = a.map.a;
    Lx(this, a.pixel, a.map)
      ? (b.classList.remove(this.a ? "ol-grab" : "ol-grabbing"),
        b.classList.add(this.a ? "ol-grabbing" : "ol-grab"))
      : b.classList.remove("ol-grab", "ol-grabbing");
  }
  function Lx(a, b, c) {
    return c.Tc(
      b,
      ...
      { layerFilter: a.C, hitTolerance: a.s }
    );
  }
  ...
  function Nx(a, b) {
    ...
    a = a.c();
    (c && a) ||
      ((c = c || b) && c.a.classList.remove("ol-grab", "ol-grabbing"));
  }
  function Mx(a, b, c) {
    Qc.call(this, a);
    this.features = b;
    ...
    this.j(
      function (a) {
        ...
        var b = (255 * a) | 0,
          c = this.T[b];
        c ||
          ((c = [new Bk({ image: new dr({ opacity: a, src: this.O }) })]),
          (this.T[b] = c));
        return c;
      }.bind(this)
    );
  ...
  function ey(a, b, c, d, e) {
    ...
    if (this.l) {
      ...
      this.c.forEach(function (a) {
        if (
          Math.max(a.source[0][0], a.source[1][0], a.source[2][0]) - n >
          this.b / 2
        ) {
          var b = [
  ...
  function fy(a, b, c, d, e, f, g, h, l, m) {
    ...
    if (u || !a.f || hb(n, a.f)) {
      ...
      if (
        0 < m &&
        (u ||
          ((n = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2])),
          (q = r
            ? (wa(f[0], q) + wa(h[0], q)) / 2 - wa(n[0], q)
            : (f[0] + h[0]) / 2 - n[0]),
          (n = (f[1] + h[1]) / 2 - n[1]),
          (u = q * q + n * n > a.v)),
        u)
  ...
  function hy(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (0 === ab(f)) this.state = 4;
      ...
      ((h = a.G()) && (e ? (e = gb(e, h)) : (e = h)),
      (d = by(a, c, eb(f), d.Ta(this.v[0]))),
      !isFinite(d) || 0 >= d)
    )
      this.state = 4;
    else if (
      ((this.o = new ey(a, c, f, e, d * (void 0 !== m ? m : 0.5))),
      0 === this.o.c.length)
    )
      this.state = 4;
    else if (
      ...
      e &&
        (a.g
          ? ((c[1] = pa(c[1], e[1], e[3])), (c[3] = pa(c[3], e[1], e[3])))
          : (c = gb(c, e))),
      ab(c))
    ) {
      a = tc(b, c, this.f);
  ...
  hy.prototype.he = function () {
    ...
    this.a.forEach(function (b) {
      b &&
        2 == b.getState() &&
        a.push({ extent: this.c.Ma(b.ya), image: b.Y() });
    }, this);
    this.a.length = 0;
          ...
          var d = y(
            ...
            function () {
              ...
              if (2 == c || 3 == c || 4 == c)
                Gc(d),
                  a--,
                  0 === a && (this.Id.forEach(Gc), (this.Id = null), this.he());
            },
            this
          );
          this.Id.push(d);
      ...
      for (var l = d.ea; l <= d.ka; ++l)
        (f = c + "/" + h + "/" + l),
          ...
          a.a.hasOwnProperty(f) &&
            ((f = a.get(f)), (g = 2 === f.getState()) && (g = !1 !== e(f))),
          g || (b = !1);
    return b;
  }
  k.Zf = function () {
  ...
  k.eb = function (a) {
    var b = this.c;
    return !this.tileGrid || (b && !Xb(b, a))
      ? ((b = x(a).toString()), b in this.s || (this.s[b] = zc(a)), this.s[b])
      : this.tileGrid;
  };
  k.Yd = function (a) {
    var b = this.c;
      ...
      this.tileGrid = Bc({
        ...
        tileSize:
          (c.imageWidth == c.imageHeight
            ? c.imageWidth
            : [c.imageWidth, c.imageHeight]) / (this.i ? 2 : 1),
      });
      var e = this.o,
        f = this.i;
      this.tileUrlFunction = Wx(
      ...
      if (c.imageryProviders) {
        ...
        this.va(function (a) {
          ...
          c.imageryProviders.map(function (c) {
            for (
              var e = !1, f = c.coverageAreas, h = 0, l = f.length;
              h < l;
              ++h
            ) {
              var m = f[h];
  ...
  k.ae = function (a, b, c) {
    ...
    b !== this.resolution &&
      (this.clear(), (this.resolution = b), wy(this), this.Qc(this.features));
  };
  k.vq = function (a) {
    this.distance = a;
    this.sa();
  ...
  yy.prototype.he = function () {
    ...
    2 == a &&
      (this.i = dy(
        ...
        this.g,
        this.f,
        [{ extent: this.Tb.G(), image: this.Tb.Y() }],
        0
      ));
    this.state = a;
    this.u();
  ...
  Iy.prototype.Wc = function (a, b, c, d) {
    ...
    a = a.slice();
    ib(a, this.La);
    (d = this.Ea(a, b, c, [(cb(a) / b) * c, (db(a) / b) * c], d)) &&
      (e = new ai(a, b, c, d));
    this.V = e;
    this.$ = this.g;
    return e;
  ...
  k.Mk = function (a, b, c, d, e) {
    ...
    this.l[0] != d[0] || this.l[1] != d[1]
      ? ((this.f.canvas.width = d[0]),
        (this.f.canvas.height = d[1]),
        (this.l[0] = d[0]),
        (this.l[1] = d[1]))
      : this.f.clearRect(0, 0, d[0], d[1]);
    this.ca.clear();
  ...
  (function (a) {
    ...
    function f(a) {
      ...
      var c = [];
      if (b) for (var f = 0; f < b; ++f) c[f] = d(a, this.xh.bind(this, f));
      else c[0] = e(a, this.xh.bind(this, 0));
      this.we = c;
      this.Nd = [];
      ...
      if (0 === this.ve && 0 < this.Nd.length) {
        ...
        if (1 === e)
          this.we[0].postMessage(
            { buffers: d, meta: a.ii, imageOps: this.Jf, width: b, height: c },
            d
          );
        else
          for (
            var f = 4 * Math.ceil(a.inputs[0].data.length / 4 / e), g = 0;
            g < e;
            ++g
          ) {
  ...
  function Ty(a) {
    for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
      var e = d,
        ...
        g = null;
      f instanceof iy
        ? ((f = new Tx({ source: f })), (g = new mj(f)))
        : f instanceof zy && ((f = new Sx({ source: f })), (g = new bj(f)));
      c[e] = g;
    }
    return c;
  }
    ...
    if (!(d.b.length <= a[0])) {
      ...
      g
        ? ((c = c.wb.split(":").pop()),
          ...
          (a = (1 == g.length ? g[0] : g[wa((a[1] << a[0]) + a[2], g.length)])
            .replace(/MapServer\/?$/, "MapServer/export")
            .replace(/ImageServer\/?$/, "ImageServer/exportImage")),
          (a = Gy(a, d)))
        : (a = void 0);
  ...
  k.al = function (a, b, c, d, e) {
    this.tileGrid
      ? ((b = this.tileGrid.Le(a, b)),
        iz(this.ad(b[0], b[1], b[2], 1, this.c), a, c, d, e))
      : !0 === e
      ? setTimeout(function () {
          c.call(d, null);
        }, 0)
  ...
  k.getData = function (a) {
    ...
    var b =
      this.f[
        Math.floor(
          (1 - (a[1] - this.a[1]) / (this.a[3] - this.a[1])) * this.f.length
        )
      ];
    if ("string" !== typeof b) return null;
    b = b.charCodeAt(
      Math.floor(((a[0] - this.a[0]) / (this.a[2] - this.a[0])) * b.length)
    );
    93 <= b && b--;
    35 <= b && b--;
    b -= 32;
    a = null;
    b in this.l &&
      ((b = this.l[b]), this.c && b in this.c ? (a = this.c[b]) : (a = b));
    return a;
  };
  ...
  k.hp = function (a, b, c, d) {
    ...
    if (!(f.b.length <= b[0])) {
      ...
      e &&
        e !== c &&
        ((g = by(e, c, a, g)), (h = bc(h, c, e)), (a = ac(a, c, e)));
      l = {
        SERVICE: "WMS",
        VERSION: "1.3.0",
        REQUEST: "GetFeatureInfo",
  ...
  function oz(a, b, c, d, e, f, g) {
    ...
    if (h) {
      ...
      g.BBOX = d.join(",");
      return Gy(
        1 == h.length ? h[0] : h[wa((b[1] << b[0]) + b[2], h.length)],
        g
      );
    }
  }
        ...
        function (a) {
          ...
          0.5 <= cb(b) / z &&
            ...
            c ||
              ((c = g(a, n, p)),
              (c = m[b] =
                new q(a, void 0 == c ? 4 : 0, void 0 == c ? "" : c, d, e)),
  ...
  k.Kh = function () {
    ...
    a == this.a.length
      ? (this.f.forEach(Gc), (this.f.length = 0), oj(this, 2))
      : oj(this, b == this.a.length ? 4 : 3);
  };
  function qz(a, b) {
  ...
  function Y(a) {
    ...
    var c = (this.ua =
        void 0 !== a.requestEncoding ? a.requestEncoding : "KVP"),
      d = a.tileGrid,
  ...
  function vz(a) {
    ...
    d.reverse();
    var l = new qc({ tileSize: f, extent: b, origin: $a(b), resolutions: d });
    (b = a.url) &&
      -1 == b.indexOf("{TileGroup}") &&
      -1 == b.indexOf("{tileIndex}") &&
      (b += "{TileGroup}/{z}-{x}-{y}.jpg");
    b = Yx(b);
    b = Wx(
      b.map(function (a) {
        return function (b) {
  ...
  t("ol.Observable.unByKey", function (a) {
    if (Array.isArray(a)) for (var b = 0, c = a.length; b < c; ++b) Gc(a[b]);
    else Gc(a);
  });
  ...
  t("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
        ...
        ? "projection" in b
          ? mc(c.TileMatrixSetLink, function (a) {
              var c = hc(d, function (b) {
                ...
                e =
                  Ob(
                    c.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3")
                  ) || Ob(c),
                f = Ob(b.projection);
    ...
    p &&
      (n =
        Ob(p.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3")) || Ob(p));
    "projection" in b &&
      ((p = Ob(b.projection)), !p || (n && !Xb(p, n)) || (n = p));
    ...
    if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata)
      for (
        a = a.OperationsMetadata.GetTile.DCP.HTTP.Get, r = 0, p = a.length;
        r < p;
        ++r
      )
        if (a[r].Constraint) {
