...
export default function EmployeeTrivia() {
                ...
                (<>
                    ...
                    >
                        ...
                        <Modal.Footer className='d-flex justify-content-center'>
                            <Link className='linkTrivia' style={{ color: "#fff" }} to={"/EmployeeGame"}>
                        ...
                        <div className="w-100">
                            ...
                            <div className='TriviaGame-wrapper'>
                                ...
                                <div className='backBtn-game-wrapper'>
                                    <Link style={{ width: "100px" }} to={"/EmployeeGame"}><button className='backBtn-game' >Back</button></Link>
                                </div>
